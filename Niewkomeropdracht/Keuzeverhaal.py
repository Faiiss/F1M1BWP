...
#introductie
print("Welkom bij het keuzeverhaal:Honderd Uri's en een dwergmarmot.")
...
#Stukje_1
    while stukje_1 == True:
        print("Het is een lange, moeizame dag geweest, je hebt een glas melk opgewarmd en gaat in bed nog een beetje liggen lezen")
        print("")
